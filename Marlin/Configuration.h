...
#define STRING_CONFIG_H_AUTHOR "(Tristan Bayfield, ASX1 SKR V1.4 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ASX1 (SKR V1.4)"
 ...
 */
//#define Z_MIN_PROBE_PIN P0_10 // Pin P0_10 is the SKR V1.4 (TURBO) default
